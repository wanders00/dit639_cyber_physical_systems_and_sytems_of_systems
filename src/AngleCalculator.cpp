...
*/
float AngleCalculator::distanceBetweenTwoMassCenters(
    float xInPoint1,
    float yInPoint1,
    float xInPoint2,
    float yInPoint2
...
*/
float AngleCalculator::calculateAngleBetweenCenters(
...
*/
float AngleCalculator::calculateTurnAngle(std::vector<cv::Point2f> yellowCenters, std::vector<cv::Point2f> blueCenters) {
...
*/
float AngleCalculator::calculateSteeringAngle(float turnAngle) {
